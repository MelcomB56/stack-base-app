...
type AppData = {
  slug: string; name: string; shortDesc: string; status: string;
  language: string | null; urlProd: string | null; urlStaging: string | null;
  repoUrl: string | null; dockerImage: string | null; dbType: string | null;
  contactName: string | null; supportEmail: string | null;
};
      ...
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <div style={PANEL}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            ...
            <Field label="Datenbank"><DSInput name="dbType" defaultValue={app.dbType ?? ""} placeholder="z.B. PostgreSQL, Redis" maxLength={50} /></Field>
          </div>
        </div>
